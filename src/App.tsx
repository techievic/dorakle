...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex flex-col items-center p-6 sm:p-12">
      ...
      >
        <span className="text-5xl sm:text-6xl font-serif italic tracking-tight text-white leading-none block">d' orakle</span>
      </motion.div>
          ...
          {screen === 'entry' && (
            ...
            >
              <motion.div variants={itemVariants} className="space-y-4">
                <h1 className="text-5xl sm:text-7xl font-serif italic tracking-tight">
                  What Coin Are You?
                </h1>
              ...
              <motion.div variants={itemVariants} className="space-y-8">
                <button
                  ...
                  disabled={words.some(w => w.length === 0)}
              ...
              >
                ...
                <div className="relative z-10 space-y-8">
                  <motion.div variants={itemVariants} className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="space-y-1">
                        <h3 className="text-5xl sm:text-6xl font-serif italic tracking-tight leading-none">
                          {result.coin}
                        </h3>
                        <span 
                  ...
                  <motion.div variants={itemVariants} className="space-y-6">
                    <div className="text-2xl sm:text-3xl font-serif italic leading-tight text-white/90 tracking-tight min-h-[4em]">
                  ...
                  >
                    ...
                    <p className="text-xl sm:text-2xl font-medium leading-snug tracking-tight">
